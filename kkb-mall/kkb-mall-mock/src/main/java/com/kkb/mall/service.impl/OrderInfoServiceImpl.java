...
import com.kkb.mall.mapper.BaseProvinceMapper;
import com.kkb.mall.mapper.OrderInfoMapper;
import com.kkb.mall.mapper.SkuInfoMapper;
import com.kkb.mall.mapper.UserInfoMapper;
import com.kkb.mall.service.*;
...
import static com.kkb.mall.common.mock.db.util.RandomNumString.*;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public  OrderInfo initOrder(Long userId ,Integer  provinceTotal ,List<Long> cartIdListForUpdate ) {
        ...
        orderInfo.setConsigneeTel("13"+ getRandNumString(0,9,9,""));
        orderInfo.setCreateTime(date);
        orderInfo.setDeliveryAddress("第"+ RandomNum.getRandInt(1,20)+"大街第"+RandomNum.getRandInt(1,40)+"号楼"+RandomNum.getRandInt(1,9)+"单元"+ getRandNumString(1,9,3,"")+"门");
        orderInfo.setExpireTime(DateUtils.addMinutes(date,15));
        orderInfo.setImgUrl("http://img.gmall.com/"+ getRandNumString(1,9,6,"")+".jpg");
        orderInfo.setOrderStatus(GmallConstant.ORDER_STATUS_UNPAID);
        orderInfo.setOrderComment("描述"+ getRandNumString(1,9,6,""));
        orderInfo.setOutTradeNo(getRandNumString(1,9,15,""));
